...
Public Class ClsConnection
    ...
    Public Function OpenConn() As Boolean
        Cn = New OleDb.OleDbConnection("Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;User ID=;Password=;Initial Catalog=Crude;Data Source=LAPTOP-KMBS99D7\SQLEXPRESS")
        Cn.Open()
